...
@section('after_styles')
    <link rel="stylesheet" href="/vendor/adminlte/plugins/fullcalendar/fullcalendar.min.css">
    <link rel="stylesheet" href="/vendor/adminlte/plugins/fullcalendar/fullcalendar.print.css" media="print">
...
@section('after_scripts')
    ...
    <script src="/vendor/adminlte/plugins/fullcalendar/fullcalendar.min.js"></script>
        ...
        $(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                @foreach ($groups as $group)
                    {
                        title: '{{$group["name"]}}',
                        start: new Date('{{explode(' ', $group['wmd_visit_from'])[0]}}'),
                        end: new Date('{{explode(' ', $group['wmd_visit_end'])[0]}}'),
                        allDay: true,
